...
namespace Ahad_Project.Controllers
{
    public class InterviewsController : Controller
    {
        ...
        {
            ViewData["InterviewerOne"] = new SelectList(_context.Employees, "Id", "Contact");
            ViewData["InterviewerThree"] = new SelectList(_context.Employees, "Id", "Contact");
            ViewData["InterviewerTwo"] = new SelectList(_context.Employees, "Id", "Contact");
        ...
        public async Task<IActionResult> Create([Bind("Id,VacId,InterviewerOne,InterviewerTwo,InterviewerThree")] Interview interview)
        {
            ...
            ViewData["InterviewerOne"] = new SelectList(_context.Employees, "Id", "Contact", interview.InterviewerOne);
            ViewData["InterviewerThree"] = new SelectList(_context.Employees, "Id", "Contact", interview.InterviewerThree);
            ViewData["InterviewerTwo"] = new SelectList(_context.Employees, "Id", "Contact", interview.InterviewerTwo);
